...
const team = [
  {
    ...
    socials: { instagram: "#", phone: "#", github: "#" },
  },
  {
    name: "Mei Lin Chen",
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-0 h-150 w-150 -translate-x-1/2 -translate-y-1/3 rounded-full bg-indigo-600/6 blur-[120px]" />
        <div className="absolute right-0 bottom-0 h-125 w-125 translate-x-1/4 translate-y-1/4 rounded-full bg-blue-600/5 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            Facilitating the development of technical competence and promoting
            collaboration among students in the technology sector
          </motion.p>
        </div>
        ...
        <div className="flex flex-col items-center gap-7">
          ...
          {/* Bottom row — centered */}
          <div className="grid w-full gap-7 sm:grid-cols-2 lg:max-w-[66.666%]">
...
function TeamCard({
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl border border-white/6 bg-white/200 backdrop-blur-sm transition-all duration-300 hover:border-blue-500/15 hover:bg-blue-500/300"
    >
      {/* Photo */}
      ...
      <div className="p-6 pt-3">
        ...
        <p className="mt-1 text-base font-medium bg-linear-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">
          {member.role}
        </p>
        <p className="mt-3 text-base leading-relaxed text-blue-200/40">
          {member.bio}
        </p>
      </div>
    </motion.div>
